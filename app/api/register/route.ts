 ...
 try{
  ...
  try{
   ...
   const payload={
    ...
    student_cast:clean(b.cast),
    dob:b.dob,
    gender:clean(b.gender),
    cnic:cnic,
    cnic_hash:cnicHash,
    guardian_cnic_hash:cnicHash,
    class_id:b.class_id,
    photo_url:photoUrl,
    status:'pending',
    address:clean(b.address)||'Not provided',
    city:clean(b.city)||'Not provided',
    admission_session:clean(b.admission_session)||'2026-27',
    emergency_name:clean(b.emergency_name)||clean(b.father_name)||'Not provided',
    emergency_phone:clean(b.emergency_phone)||'Not provided',
    relationship:clean(b.relationship)||'Father'
   };
